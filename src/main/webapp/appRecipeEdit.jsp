        ...
        <div class="m-4 p-3 width-medium text-color-darker">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <div class="mt-4 ml-4 mr-4">
                    <form method="post" action="${pageContext.request.contextPath}/app/recipe/edit">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7"> <textarea class="w-100 p-1" rows="5" name="description">${recipe.getDescription()}</textarea></td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                                <td class="col-3">
                                    <input class="p-1" type="number" name="time" id="time" value="${recipe.getPreparationTime()}">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="row d-flex">
                            <div class="col-5 p-4">
                                <textarea class="w-100 p-1" rows="10" name="preparation">${recipe.getPreparation()}</textarea>
                            </div>
                            <div class="col-2"></div>
